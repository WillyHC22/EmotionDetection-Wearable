...
def get_parser():
    ...
    parser.add_argument("-p2", "--servo_pin2", type=int, default=10, help="pin used on raspberry board for servo 2")
    parser.add_argument("-p3", "--servo_pin3", type=int, default=11, help="pin used on raspberry board for servo 3")
    parser.add_argument("-p4", "--servo_pin4", type=int, default=12, help="pin used on raspberry board for servo 4")
